\Block{Complex 4-bit Multiplier Implemented in Slices}{cmult\_4bit\_sl}{cmult4bitsl}{Aaron Parsons}{Vinayak Nagpal}{Perform a complex multiplication \emph{(a+bi)(c-di)=(ac-bd)+(ad+bc)i}. Implements the logic in Slices.}
...
\BlockDesc{Perform a complex multiplication \emph{(a+bi)(c-di)=(ac-bd)+(ad+bc)i}. Implements the logic in Slices. }