...
# D:\casper10_1\projects\radix4\r4_5g_specD5\XPS_ROACH_base\system.mhs
# The software specification of the system is in file :
# D:\casper10_1\projects\radix4\r4_5g_specD5\XPS_ROACH_base\system.mss
...
epb_opb_bridge_inst_libsclean:
	rm -rf epb_opb_bridge_inst/
...
$(EPB_OPB_BRIDGE_INST_BOOTLOOP): 
	@mkdir -p $(BOOTLOOP_DIR)
	cp -f  $(EPB_OPB_BRIDGE_INST_BOOTLOOP)
...
$(SYSTEM_ACE): $(DOWNLOAD_BIT) 
	...
	@echo "*********************************************"
	xmd -tcl genace.tcl -jprog -hw $(DOWNLOAD_BIT) -elf  -target ppc_hw  -ace $(SYSTEM_ACE)
