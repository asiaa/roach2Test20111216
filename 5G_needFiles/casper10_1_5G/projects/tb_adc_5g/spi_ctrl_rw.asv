function [spi_rst, spi_clk, spi_cs, spi_mosi,spi_rd_data] = spi_ctrl_rw(clk_in,s_data,s_cs,spi_miso)
  ...
  persistent spi_miso_reg, spi_miso_reg = xl_state(0, {xlUnsigned, 1, 0});
  persistent s_data_reg, s_data_reg = xl_state(0, {xlUnsigned, 32, 0});
  persistent s_cs_reg, s_cs_reg = xl_state(0, {xlUnsigned, 32, 0});
  persistent spi_rd_data_reg, spi_rd_data_reg = xl_state(0, {xlUnsigned, 32, 0});
