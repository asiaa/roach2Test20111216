...
while(1):
    for server,b in enumerate(bees):
        ...
        print '-----------------------------------------'
        for f in fpgas:
            print '%s ADC top I:    %.3f (%2.2f bits used)'%(f, adc_rms[f]['adc_top_I'],adc_bits_used[f]['adc_top_I'])
            print '%s ADC top Q:    %.3f (%2.2f bits used)'%(f, adc_rms[f]['adc_top_Q'],adc_bits_used[f]['adc_top_Q'])
            print '%s ADC bottom I: %.3f (%2.2f bits used)'%(f, adc_rms[f]['adc_bot_I'],adc_bits_used[f]['adc_bot_I'])
            print '%s ADC bottom Q: %.3f (%2.2f bits used)'%(f, adc_rms[f]['adc_bot_Q'],adc_bits_used[f]['adc_bot_Q'])
        time.sleep(1)
