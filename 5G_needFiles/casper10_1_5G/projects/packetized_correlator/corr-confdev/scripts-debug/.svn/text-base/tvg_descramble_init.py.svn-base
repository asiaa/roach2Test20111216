...
"""
Inserts a counter into the X engine and analyses the output to ensure that the X engine block 
...
if __name__ == '__main__':
    ...
    p = OptionParser()
    p.set_usage('tvg_descramble_init.py [options] CONFIG_FILE')
...
print '==================================='
print 'Selecting X engine tvgs with constants... ',
