...
Revisions: 
    ...
    01/30/2008  jrm     Removed bandpass transpose
"""
__version__ = '0.1.1'
...
class MiriadParams(dict):
    ...
    def __init__(self, **kwargs):
        ...
        #print 'C2M location: ',len(prms['location']),prms['location']
        self.aa = aipy.ant.AntennaArray(ants=ants, location=prms['location'])
