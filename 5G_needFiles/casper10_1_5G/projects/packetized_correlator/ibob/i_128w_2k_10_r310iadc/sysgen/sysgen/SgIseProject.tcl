namespace eval ::xilinx::dsptool::iseproject {
    ...
    proc process_parameters {} {
        ...
        optional_parameter param::SynthesisRegisterBalancing {Yes}
    ...
    proc set_xst_synthesis_settings {} {
        ...
        ise::project set {Register Duplication} $param::SynthesisRegisterDuplication -process {Synthesize}
    ...
    proc set_synplify_synthesis_settings {} {
        ...
        switch $param::SynthesisTool {
            ...
            "Synplify Pro" {
                ...
                ise::project set {Retiming} $param::SynthesisRetiming -process {Synthesize}
            }
        }
    ...
    proc set_implementation_settings {} {
        ...
        switch -- $param::Family {
            "virtex5" {
                ...
                ise::project set {Register Duplication} $param::MapRegisterDuplication -process {Map}
            }
    ...
    proc set_simulation_settings {} {
        if [info exists param::Simulator] {
            switch [string tolower $param::Simulator] {
                "ise simulator" {
                    ise::project set {Simulator} "$param::Simulator (VHDL/Verilog)"
                }
                default {
        ...
        set is_vhdl [expr { $param::HDLLanguage eq "VHDL" }]
        if {[info exists param::TestBenchModule] && $is_vhdl} {
