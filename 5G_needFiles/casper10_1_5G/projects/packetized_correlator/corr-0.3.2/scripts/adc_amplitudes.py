...
if __name__ == '__main__':
    ...
    p.add_option('-s', '--single_capture', dest='single_capture', default=False, action='store_true', 
        help='Capture a single snapshot of the ADC powers')
...
while(cont_loop):
    ...
    if opts.single_capture is False:
        #print the output                
        time.sleep(1)
        #Move cursor home:
        print '%c[H'%chr(27)
