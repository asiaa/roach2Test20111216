...
% end if strcmp(adc_interleave,'on')
    ...
    try
        ...
        set_param([myname,'/o8'],'Name', 'q4');
        set_param([myname,'/o9'],'Name', 'i4');
        set_param([myname,'/o10'],'Name', 'q5');
        set_param([myname,'/o11'],'Name', 'i5');
        set_param([myname,'/o12'],'Name', 'q6');
        set_param([myname,'/o13'],'Name', 'i6');
        set_param([myname,'/o14'],'Name', 'q7');
        set_param([myname,'/o15'],'Name', 'i7');

        set_param([myname,'/i0'],'Port', '1');
        set_param([myname,'/i1'],'Port', '2');
        set_param([myname,'/i2'],'Port', '3');
        set_param([myname,'/i3'],'Port', '4');
        set_param([myname,'/q0'],'Port', '9');
        set_param([myname,'/q1'],'Port', '10');
        set_param([myname,'/q2'],'Port', '11');
        set_param([myname,'/q3'],'Port', '12');

        set_param([myname,'/i4'],'Port', '5');
        set_param([myname,'/i5'],'Port', '6');
        set_param([myname,'/i6'],'Port', '7');
        set_param([myname,'/i7'],'Port', '8');
        set_param([myname,'/q4'],'Port', '13');
        set_param([myname,'/q5'],'Port', '14');
        set_param([myname,'/q6'],'Port', '15');
        set_param([myname,'/q7'],'Port', '16');
