...
def plot_spectrum():
    ...
    a_0=struct.unpack('>1024l',fpga.read('snap_vacc0_bram',512*8,0))
    a_1=struct.unpack('>1024l',fpga.read('snap_vacc1_bram',512*8,0))
    a_2=struct.unpack('>1024l',fpga.read('snap_vacc2_bram',512*8,0))
    a_3=struct.unpack('>1024l',fpga.read('snap_vacc3_bram',512*8,0))
    a_4=struct.unpack('>1024l',fpga.read('snap_vacc4_bram',512*8,0))
    a_5=struct.unpack('>1024l',fpga.read('snap_vacc5_bram',512*8,0))
    a_6=struct.unpack('>1024l',fpga.read('snap_vacc6_bram',512*8,0))
    a_7=struct.unpack('>1024l',fpga.read('snap_vacc7_bram',512*8,0))
